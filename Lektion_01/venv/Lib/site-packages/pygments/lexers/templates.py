...
class MyghtyJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+myghty', 'des.js_+myghty']
...
class MyghtyCssLexer(DelegatingLexer):
    ...
    name = 'CSS+Myghty'
    aliases = ['_temp+myghty']
    mimetypes = ['text/_temp+myghty']
...
class MakoJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+mako', 'des.js_+mako']
...
class CheetahJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+cheetah', 'des.js_+cheetah',
               'javascript+spitfire', 'des.js_+spitfire']
...
class JavascriptGenshiLexer(DelegatingLexer):
    ...
    aliases = ['des.js_+genshitext', 'des.js_+genshi', 'javascript+genshitext',
               'javascript+genshi']
    alias_filenames = ['*.des.js_']
...
class CssGenshiLexer(DelegatingLexer):
    ...
    aliases = ['_temp+genshitext', '_temp+genshi']
    alias_filenames = ['*._temp']
    mimetypes = ['text/_temp+genshi']
...
class CssErbLexer(DelegatingLexer):
    ...
    name = 'CSS+Ruby'
    aliases = ['_temp+ruby', '_temp+erb']
    alias_filenames = ['*._temp']
    mimetypes = ['text/_temp+ruby']
...
class JavascriptErbLexer(DelegatingLexer):
    ...
    aliases = ['javascript+ruby', 'des.js_+ruby', 'javascript+erb', 'des.js_+erb']
    alias_filenames = ['*.des.js_']
...
class JavascriptPhpLexer(DelegatingLexer):
    ...
    name = 'JavaScript+PHP'
    aliases = ['javascript+php', 'des.js_+php']
    alias_filenames = ['*.des.js_']
...
class CssSmartyLexer(DelegatingLexer):
    ...
    name = 'CSS+Smarty'
    aliases = ['_temp+smarty']
    alias_filenames = ['*._temp', '*.tpl']
    mimetypes = ['text/_temp+smarty']
...
class JavascriptSmartyLexer(DelegatingLexer):
    ...
    aliases = ['javascript+smarty', 'des.js_+smarty']
    alias_filenames = ['*.des.js_', '*.tpl']
...
class CssDjangoLexer(DelegatingLexer):
    ...
    aliases = ['_temp+django', '_temp+jinja']
    filenames = ['*._temp.j2', '*._temp.jinja2']
    alias_filenames = ['*._temp']
    mimetypes = ['text/_temp+django', 'text/_temp+jinja']
...
class JavascriptDjangoLexer(DelegatingLexer):
    ...
    aliases = ['javascript+django', 'des.js_+django',
               'javascript+jinja', 'des.js_+jinja']
    filenames = ['*.des.js_.j2', '*.des.js_.jinja2']
    alias_filenames = ['*.des.js_']
...
class LassoJavascriptLexer(DelegatingLexer):
    ...
    aliases = ['javascript+lasso', 'des.js_+lasso']
    alias_filenames = ['*.des.js_']
