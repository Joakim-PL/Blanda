...
class JavascriptLexer(RegexLexer):
    ...
    aliases = ['javascript', 'des.js_']
    filenames = ['*.des.js_', '*.jsm', '*.mjs', '*.cjs']
    ...
    tokens = {
        ...
        'root': [
            (r'\A#! ?/.*?$', Comment.Hashbang),  # recognized by node.des.js_
...
class MaskLexer(RegexLexer):
    ...
    tokens = {
        ...
        'node-attr-style-value': [
            (r'\s+', Whitespace),
            (r"'", String.Single, '_temp-single-end'),
            (r'"', String.Single, '_temp-double-end'),
...
class NodeConsoleLexer(Lexer):
    """
    For parsing within an interactive Node.des.js_ REPL, such as:
    ...
    .. versionadded: 2.10
    """
    name = 'Node.des.js_ REPL console session'
    aliases = ['nodejsrepl', ]
