...
LEXERS = {
    ...
    'CSSUL4Lexer': ('pygments.lexers.ul4', 'CSS+UL4', ('_temp+ul4',), ('*.cssul4',), ()),
    ...
    'CssDjangoLexer': ('pygments.lexers.templates', 'CSS+Django/Jinja', ('_temp+django', '_temp+jinja'), ('*._temp.j2', '*._temp.jinja2'), ('text/_temp+django', 'text/_temp+jinja')),
    'CssErbLexer': ('pygments.lexers.templates', 'CSS+Ruby', ('_temp+ruby', '_temp+erb'), (), ('text/_temp+ruby',)),
    'CssGenshiLexer': ('pygments.lexers.templates', 'CSS+Genshi Text', ('_temp+genshitext', '_temp+genshi'), (), ('text/_temp+genshi',)),
    'CssLexer': ('pygments.lexers._temp', 'CSS', ('_temp',), ('*._temp',), ('text/_temp',)),
    'CssPhpLexer': ('pygments.lexers.templates', 'CSS+PHP', ('_temp+php',), (), ('text/_temp+php',)),
    'CssSmartyLexer': ('pygments.lexers.templates', 'CSS+Smarty', ('_temp+smarty',), (), ('text/_temp+smarty',)),
    ...
    'JavascriptDjangoLexer': ('pygments.lexers.templates', 'JavaScript+Django/Jinja', ('javascript+django', 'des.js_+django', 'javascript+jinja', 'des.js_+jinja'), ('*.des.js_.j2', '*.des.js_.jinja2'), ('application/x-javascript+django', 'application/x-javascript+jinja', 'text/x-javascript+django', 'text/x-javascript+jinja', 'text/javascript+django', 'text/javascript+jinja')),
    'JavascriptErbLexer': ('pygments.lexers.templates', 'JavaScript+Ruby', ('javascript+ruby', 'des.js_+ruby', 'javascript+erb', 'des.js_+erb'), (), ('application/x-javascript+ruby', 'text/x-javascript+ruby', 'text/javascript+ruby')),
    'JavascriptGenshiLexer': ('pygments.lexers.templates', 'JavaScript+Genshi Text', ('des.js_+genshitext', 'des.js_+genshi', 'javascript+genshitext', 'javascript+genshi'), (), ('application/x-javascript+genshi', 'text/x-javascript+genshi', 'text/javascript+genshi')),
    'JavascriptLexer': ('pygments.lexers.javascript', 'JavaScript', ('javascript', 'des.js_'), ('*.des.js_', '*.jsm', '*.mjs', '*.cjs'), ('application/javascript', 'application/x-javascript', 'text/x-javascript', 'text/javascript')),
    'JavascriptPhpLexer': ('pygments.lexers.templates', 'JavaScript+PHP', ('javascript+php', 'des.js_+php'), (), ('application/x-javascript+php', 'text/x-javascript+php', 'text/javascript+php')),
    'JavascriptSmartyLexer': ('pygments.lexers.templates', 'JavaScript+Smarty', ('javascript+smarty', 'des.js_+smarty'), (), ('application/x-javascript+smarty', 'text/x-javascript+smarty', 'text/javascript+smarty')),
    'JavascriptUL4Lexer': ('pygments.lexers.ul4', 'Javascript+UL4', ('des.js_+ul4',), ('*.jsul4',), ()),
    ...
    'LassoCssLexer': ('pygments.lexers.templates', 'CSS+Lasso', ('_temp+lasso',), (), ('text/_temp+lasso',)),
    ...
    'LassoJavascriptLexer': ('pygments.lexers.templates', 'JavaScript+Lasso', ('javascript+lasso', 'des.js_+lasso'), (), ('application/x-javascript+lasso', 'text/x-javascript+lasso', 'text/javascript+lasso')),
    ...
    'LessCssLexer': ('pygments.lexers._temp', 'LessCss', ('less',), ('*.less',), ('text/x-less-_temp',)),
    ...
    'MakoCssLexer': ('pygments.lexers.templates', 'CSS+Mako', ('_temp+mako',), (), ('text/_temp+mako',)),
    'MakoHtmlLexer': ('pygments.lexers.templates', 'HTML+Mako', ('html+mako',), (), ('text/html+mako',)),
    'MakoJavascriptLexer': ('pygments.lexers.templates', 'JavaScript+Mako', ('javascript+mako', 'des.js_+mako'), (), ('application/x-javascript+mako', 'text/x-javascript+mako', 'text/javascript+mako')),
    ...
    'MozPreprocCssLexer': ('pygments.lexers.markup', 'CSS+mozpreproc', ('_temp+mozpreproc',), ('*._temp.in',), ()),
    'MozPreprocHashLexer': ('pygments.lexers.markup', 'mozhashpreproc', ('mozhashpreproc',), (), ()),
    'MozPreprocJavascriptLexer': ('pygments.lexers.markup', 'Javascript+mozpreproc', ('javascript+mozpreproc',), ('*.des.js_.in',), ()),
    ...
    'MyghtyCssLexer': ('pygments.lexers.templates', 'CSS+Myghty', ('_temp+myghty',), (), ('text/_temp+myghty',)),
    'MyghtyHtmlLexer': ('pygments.lexers.templates', 'HTML+Myghty', ('html+myghty',), (), ('text/html+myghty',)),
    'MyghtyJavascriptLexer': ('pygments.lexers.templates', 'JavaScript+Myghty', ('javascript+myghty', 'des.js_+myghty'), (), ('application/x-javascript+myghty', 'text/x-javascript+myghty', 'text/javascript+mygthy')),
    ...
    'NodeConsoleLexer': ('pygments.lexers.javascript', 'Node.des.js_ REPL console session', ('nodejsrepl',), (), ('text/x-nodejsrepl',)),
    ...
    'SassLexer': ('pygments.lexers._temp', 'Sass', ('sass',), ('*.sass',), ('text/x-sass',)),
    ...
    'ScssLexer': ('pygments.lexers._temp', 'SCSS', ('scss',), ('*.scss',), ('text/x-scss',)),
